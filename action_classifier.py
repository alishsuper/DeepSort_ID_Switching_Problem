...
class ClassifierOnlineTest(object):
    ...
    def __init__(self, model_path, action_types, human_id=0):
        ...
        self.THRESHOLD_SCORE_FOR_DISP = 0.1
    ...
    def draw_scores_onto_image(self, image_disp, ii):
        ...
        for i in range(-1, len(self.action_types)):
            ...
            cv2.putText(image_disp, text=s, org=(TXT_X, TXT_Y),
                fontFace=cv2.FONT_HERSHEY_DUPLEX, fontScale=FONT_SIZE,
                color=(0, 0, int(COLOR_INTENSITY)), thickness=4)
